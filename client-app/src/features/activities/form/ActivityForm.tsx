...
export default function ActivityForm({ handleCloseForm, activity,creatOrEdit }: Props) {
    ...
    return (
        <Segment clearing>
            <Form onSubmit={funcHandleSubmit} autoComplete='off'>
                ...
                <Form.Input placeholder="Date" name='date' value={stateActivity.date} onChange={handleOnChange}/>
